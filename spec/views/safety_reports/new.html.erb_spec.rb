...
RSpec.describe "safety_reports/new", type: :view do
  before(:each) do
    assign(:safety_report, SafetyReport.new(
  ...
  it "renders new safety_report form" do
    render

    assert_select "form[action=?][method=?]", safety_reports_path, "post" do
